...
const LIST_DATA = [
  ...
  { type: '新品Listing', site: 'US', brand: 'AUVON', sub: '贴片', name: '针形贴片20pack',  sku: 'PO17X4011', bu: '物理治疗', bu_lead: 'Suki', op: 'Jessi', writer: 'Yumi',  status: '处理中', submit_time: '2026/02/09 08:55:21', launch_date: '2026/02/21', date: '2026/02/12' },
  ...
  { type: '新品Listing', site: 'US', brand: 'ZIKEE', sub: '贴片', name: '医疗款TENS套装',  sku: 'PO17X4011', bu: '北美市场', bu_lead: 'Suki', op: 'Liz',   writer: 'Brian', status: '待审核', submit_time: '2026/02/09 16:08:52', launch_date: '2026/02/24', date: '2026/02/12' },
  ...
  { type: '老品Title TD', site: 'UK', brand: 'AUVON', sub: '药盒', name: '7格旅行药盒',    sku: 'PO19A2210', bu: '物理治疗', bu_lead: 'Suki', op: 'Tina',  writer: 'Lucy',  status: '待审核', submit_time: '2026/02/11 08:42:55', date: '2026/02/14' },
